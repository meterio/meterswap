    ...
    <Wrapper showBackground={true} bgColor={'#2172E5'}>
      ...
      <TopSection>
        ...
        </TYPE.white>
        {
          isVoltPool ?
          <StyledExternalLink
          href={chainId === 361 ? `https://thetafarm.voltswap.finance?farm=${tokenPair.token0.symbol}` :
           chainId === 1284 ?`https://moonfarm.voltswap.finance?farm=${tokenPair.token0.symbol}`: `https://farm.voltswap.finance?farm=${tokenPair.token0.symbol}`}
        >
        ...
        <StyledExternalLink
        href={chainId === 361 ?`https://thetafarm.voltswap.finance?farm=${tokenPair.token0.symbol === 'WTFUEL' ? 'TFUEL' :
